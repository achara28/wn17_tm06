...
(function() {
  var Framebuffer, Heights, Node, Shader, Texture, WebGLCoverageMap, fragmentShaderBlit, nukeVendorPrefix, textureFloatShims, vertexShaderBlit,
  ...
  Heights = (function() {
    function Heights(heatmap, gl, width, height) {
      ...
      this.shader = new Shader(this.gl, {
        ...
        vertex: 'attribute vec4 position, intensity;\nvarying vec2 off, dim;\nvarying float vIntensity;\nuniform vec2 viewport;\n\nvoid main(){\n    dim = abs(position.zw);\n    off =position.zw;\n    vec2 pos = position.xy + position.zw;\n    vIntensity = intensity.x;\n    gl_Position = vec4((pos/viewport)*2.0-1.0, 0.0, 1.0);\n}',
        fragment: '#ifdef GL_FRAGMENT_PRECISION_HIGH\n    precision highp int;\n    precision highp float;\n#else\n    precision mediump int;\n    precision mediump float;\n#endif\nvarying vec2 off, dim;\nvarying float vIntensity;\nvoid main(){\n    float falloff = 1.0;//(1.0 - smoothstep(1.0, 1.0, length(off/dim)));\n    float intensity = falloff*vIntensity;\n    gl_FragColor = vec4(intensity);\n}'
      });
  ...
  WebGLCoverageMap = (function() {
    function WebGLCoverageMap(_arg) {
    ...
    WebGLCoverageMap.prototype.adjustSize = function() {
    ...
    WebGLCoverageMap.prototype.display = function() {
      this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.quad);
      this.gl.vertexAttribPointer(0, 4, this.gl.FLOAT, false, 0, 0);
    ...
    WebGLCoverageMap.prototype.update = function() {
      return this.heights.update();
    };

    WebGLCoverageMap.prototype.clear = function() {
      return this.heights.clear();
    };

    WebGLCoverageMap.prototype.clamp = function(min, max) {
      if (min == null) {
        min = 0;
      }
      if (max == null) {
    ...
    WebGLCoverageMap.prototype.multiply = function(value) {
      if (value == null) {
        value = 0.95;
      }
    ...
    WebGLCoverageMap.prototype.blur = function() {
      return this.heights.blur();
    };

    WebGLCoverageMap.prototype.addPoint = function(x, y, size, intensity) {
      return this.heights.addPoint(x, y, size, intensity);
    };

    WebGLCoverageMap.prototype.addPoints = function(items) {
    ...
    return WebGLCoverageMap;

  })();

  window.createWebGLCoverageMap = function(params) {
    return new WebGLCoverageMap(params);
  };
