...
(function ($) {/*jshint indent: 4, browser:true*/
    ...
    L.TimeDimension.Layer.AjaxGeoJSON = L.TimeDimension.Layer.extend({
        ...
        _getDataForTime: function (time) {
            ...
            var date = moment(time).tz(timezone).format("YYYYMMDDHHmm");

            var startdate = moment(time).tz(timezone).format("YYYYMMDDHHmm");

            var enddate = moment(time).tz(timezone).add(30, "minute").format("YYYYMMDDHHmm");
            ...
            var callback = function (status, data) {
                ...
                this.fire('timeload', {
                    time: time,
                    data: this._currentTimeData
                });
            };
            var auth = this.options.authdata;
            ...
            $.ajax({
                ...
                dataType: "json",
                success: callback.bind(this, 'ok'),
                failure: callback.bind(this, 'error'),
    ...
    L.Control.TimeDimension = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            if (this.options.speedSlider) {
                this._sliderSpeed = this._createSliderSpeed(this.options.styleNS + ' timecontrol-slider timecontrol-maxspeed', container);
            }
        ...
        _onPlayerStateChange: function () {
            ...
            if (this._sliderSpeed && !this._draggingSpeed) {
                ...
                maxspeed = Math.round(10000 / maxspeed) / 10; // 1s / transition
                this._sliderSpeed.setValue(maxspeed);
            }
        },
        ...
        _createSliderSpeed: function (className, container) {
            ...
            /* L.DomEvent
             ...
             .addListener(sliderContainer, 'click', L.DomEvent.preventDefault);
             */
            var speedLabel = L.DomUtil.create('span', 'maxspeed', sliderContainer);
