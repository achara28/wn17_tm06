		...
		<div class="modal-dialog">
			...
			<div class="modal-content" style="color: #4c4c4c;">
				...
				<div class="modal-body">
					...
					@if ($question->anleo)
					<h4><strong> Question : <span style="color: #4c4c4c;">{{$question->question}} </span> </strong></h4>

					<p><strong>Answer1 : </strong> <span style="color: #f9b754">{{$question->answer1}}</span></p>
					<p><strong>Answer2 : </strong> <span style="color: #296cc6" >{{$question->answer2}}</span></p>
					<p><strong>Answer3 : </strong> <span style="color: #ce3d3d" >{{$question->answer3}}</span></p>
					<p><strong>Answer4 : </strong> <span style="color: #60a850" >{{$question->answer4}}</span></p>
					<br>
